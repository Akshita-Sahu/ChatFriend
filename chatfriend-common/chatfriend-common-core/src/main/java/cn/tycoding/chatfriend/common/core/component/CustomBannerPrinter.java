...
package cn.tycoding.chatfriend.common.core.component;
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        System.out.println("""
                ...
                /_____/\\__,_/_/ /_/\\__, /   \\____/_/ /_/\\__,_/\\__/
                                  /____/
                    Copyright (c) 2025 ChatFriend. Made by Akshita Sahu. All Rights Reserved.         
                     ChatFriend采用AGPL协议，允许个人学习使用，商业化项目请联系作者授权
                
                - WebSite: http://chatfriend.cn
                - Email: chatfriend@outlook.com
                - Author: TyCoding
                - WeiXin: LangchainChat
                """);

        log.info("ChatFriend 启动完成...... 当前环境：{}", event.getApplicationContext().getEnvironment().getActiveProfiles());
    }
}
