CREATE DATABASE IF NOT EXISTS chatfriend;
USE chatfriend;
...
-- ----------------------------
BEGIN;
INSERT INTO `aigc_app` (`id`, `model_id`, `knowledge_ids`, `cover`, `name`, `prompt`, `des`, `save_time`, `create_time`) VALUES ('e16a582b47d3041cf14074d5451dff7a', '0c21c2f8ebd3aa3757ef1bae81154cc4', '[\"393704ac13f67fde5da674ddd0742b03\"]', 'http://cdn.tycoding.cn/tycoding.jpg', 'ChatFriend官方应用', '你是一个专业的文档分析师，你擅长从文档中提取关键内容并总结分析含义，下面你需要根据用户的问题做出解答。\n\n## 限制\n不要回答和文档无关的内容', '快速解答ChatFriend项目相关的内容，ChatFriend官方助手', '2024-08-10 11:39:41', '2024-08-04 17:49:24');
COMMIT;
...
INSERT INTO `aigc_docs` (`id`, `knowledge_id`, `name`, `type`, `url`, `origin`, `content`, `size`, `slice_num`, `slice_status`, `create_time`) VALUES ('8933fc0e6b449a153adc1789a4e1781c', '393704ac13f67fde5da674ddd0742b03', 'guide1', 'INPUT', NULL, NULL, 'ChatFriend 是一个基于Java生态的企业AI知识库和大模型应用解决方案，帮助企业快速搭建AI大模型应用。 同时，ChatFriend也集成了RBAC权限体系，为企业提供开箱即用的AI大模型产品解决方案。\n\nChatFriend 使用Java生态，前后端分离，并采用最新的技术栈开发。后端基于SpringBoot3，前端基于Vue3。 ChatFriend不仅为企业提供AI领域的产品解决方案，也是一个完整的Java企业级应用案例。这个系统带你全面了解SpringBoot3和Vue3的前后端开发流程、业务模块化，以及AI应用集成方案。 无论是企业开发，还是个人学习，ChatFriend都为你提供丰富的学习案例', NULL, 1, 1, '2024-08-04 18:18:46');
INSERT INTO `aigc_docs` (`id`, `knowledge_id`, `name`, `type`, `url`, `origin`, `content`, `size`, `slice_num`, `slice_status`, `create_time`) VALUES ('ec0c960461a615bb7c7648d7ee5801b5', '393704ac13f67fde5da674ddd0742b03', 'story-about-happy-carrot.pdf', 'UPLOAD', 'http://127.0.0.1/chatfriend/2024080866b4b069cdb262aeea8da409.pdf', NULL, NULL, 35359, 37, 1, '2024-08-08 19:47:54');
...
-- ----------------------------
BEGIN;
INSERT INTO `aigc_knowledge` (`id`, `user_id`, `embed_store_id`, `embed_model_id`, `name`, `des`, `cover`, `create_time`) VALUES ('393704ac13f67fde5da674ddd0742b03', NULL, '5d57795705faccdf0ea7095a63c5e463', '1f0525bcf8721689f6a81851e5a0068b', 'ChatFriend文档', 'ChatFriend官方文档', NULL, '1722766331165');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `aigc_oss` (`id`, `user_id`, `oss_id`, `original_filename`, `filename`, `url`, `base_path`, `path`, `size`, `ext`, `content_type`, `platform`, `create_time`) VALUES ('496a1c3a6798e6b9f52e071d533753d1', '91b4524a46a949601e7f3b004ed76034', NULL, '36946717.JPEG', '66b6df5ecdb26cd406afc109.JPEG', 'http://127.0.0.1/chatfriend/2024081066b6df5ecdb26cd406afc109.JPEG', 'chatfriend/', '20240810', 11744, 'JPEG', 'image/jpeg', 'local', '2024-08-10 11:32:47');
INSERT INTO `aigc_oss` (`id`, `user_id`, `oss_id`, `original_filename`, `filename`, `url`, `base_path`, `path`, `size`, `ext`, `content_type`, `platform`, `create_time`) VALUES ('55b5b75061c0a229ec0114fc62853a0c', '91b4524a46a949601e7f3b004ed76034', NULL, 'story-about-happy-carrot.pdf', '66b4afeecdb2c038a2624532.pdf', 'http://cdn.tycoding.cn/chatfriend/2024080866b4afeecdb2c038a2624532.pdf', 'chatfriend/', '20240808', 35359, 'pdf', 'application/pdf', 'qiniu', '2024-08-08 19:45:51');
INSERT INTO `aigc_oss` (`id`, `user_id`, `oss_id`, `original_filename`, `filename`, `url`, `base_path`, `path`, `size`, `ext`, `content_type`, `platform`, `create_time`) VALUES ('6a91df3d44a2fdfe6c8fcc83844757c8', '91b4524a46a949601e7f3b004ed76034', NULL, 'story-about-happy-carrot.pdf', '66b239dbcdb2ff916a0a092c.pdf', 'http://cdn.tycoding.cn/chatfriend/2024080666b239dbcdb2ff916a0a092c.pdf', 'chatfriend/', '20240806', 35359, 'pdf', 'application/pdf', 'qiniu', '2024-08-06 22:57:32');
INSERT INTO `aigc_oss` (`id`, `user_id`, `oss_id`, `original_filename`, `filename`, `url`, `base_path`, `path`, `size`, `ext`, `content_type`, `platform`, `create_time`) VALUES ('726bc0a42f0753c78672bedb8529c2c4', '91b4524a46a949601e7f3b004ed76034', NULL, 'story-about-happy-carrot.pdf', '66b4b069cdb262aeea8da409.pdf', 'http://127.0.0.1/chatfriend/2024080866b4b069cdb262aeea8da409.pdf', 'chatfriend/', '20240808', 35359, 'pdf', 'application/pdf', 'local', '2024-08-08 19:47:54');
INSERT INTO `aigc_oss` (`id`, `user_id`, `oss_id`, `original_filename`, `filename`, `url`, `base_path`, `path`, `size`, `ext`, `content_type`, `platform`, `create_time`) VALUES ('7ef543675e89ef3fea19563b667c1454', '91b4524a46a949601e7f3b004ed76034', NULL, 'story-about-happy-carrot.pdf', '66b489b0cdb2a4b1a529719f.pdf', 'http://cdn.tycoding.cn/chatfriend/2024080866b489b0cdb2a4b1a529719f.pdf', 'chatfriend/', '20240808', 35359, 'pdf', 'application/pdf', 'qiniu', '2024-08-08 17:02:41');
INSERT INTO `aigc_oss` (`id`, `user_id`, `oss_id`, `original_filename`, `filename`, `url`, `base_path`, `path`, `size`, `ext`, `content_type`, `platform`, `create_time`) VALUES ('b572ec6532f03530b8c2b45c93a26141', '91b4524a46a949601e7f3b004ed76034', NULL, '36946717.JPEG', '66b6e0fbcdb220c420fe6bae.JPEG', 'http://127.0.0.1/chatfriend/2024081066b6e0fbcdb220c420fe6bae.JPEG', 'chatfriend/', '20240810', 11744, 'JPEG', 'image/jpeg', 'local', '2024-08-10 11:39:40');
INSERT INTO `aigc_oss` (`id`, `user_id`, `oss_id`, `original_filename`, `filename`, `url`, `base_path`, `path`, `size`, `ext`, `content_type`, `platform`, `create_time`) VALUES ('cc5bd4fffb8da1296bc87cc40ececb66', '91b4524a46a949601e7f3b004ed76034', NULL, '36946717.JPEG', '66b6e0a2cdb26cd406afc10a.JPEG', 'http://127.0.0.1/chatfriend/2024081066b6e0a2cdb26cd406afc10a.JPEG', 'chatfriend/', '20240810', 11744, 'JPEG', 'image/jpeg', 'local', '2024-08-10 11:38:10');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`id`, `username`, `password`, `real_name`, `sex`, `phone`, `email`, `dept_id`, `avatar`, `status`, `create_time`) VALUES ('827450c4a39b3c4c14fdfb06f454bfb3', 'chatfriend', 'U3lnYOIEGN38KKy0h3KUSA==', '演示环境账号', '男', '19809587831', 'chatfriend@outlook.com', '14b300858a898c6dcfd3dc95dde6df81', NULL, 1, '2024-08-04 13:55:35');
INSERT INTO `sys_user` (`id`, `username`, `password`, `real_name`, `sex`, `phone`, `email`, `dept_id`, `avatar`, `status`, `create_time`) VALUES ('91b4524a46a949601e7f3b004ed76034', 'administrator', 'U3lnYOIEGN38KKy0h3KUSA==', '超级管理员', '男', '19809587831', 'chatfriend@outlook.com', NULL, NULL, 0, '2024-08-04 13:55:35');
COMMIT;
...
-- ----------------------------
-- Table structure for chatfriend_user_profile
-- ----------------------------
DROP TABLE IF EXISTS `chatfriend_user_profile`;
CREATE TABLE `chatfriend_user_profile` (
  `id` varchar(50) NOT NULL,
  `user_id` varchar(50) NOT NULL COMMENT 'sys_user ID',
...
-- ----------------------------
-- Table structure for chatfriend_message_reactions
-- ----------------------------
DROP TABLE IF EXISTS `chatfriend_message_reactions`;
CREATE TABLE `chatfriend_message_reactions` (
  `id` varchar(50) NOT NULL,
...
-- ----------------------------
-- Table structure for chatfriend_read_receipts
-- ----------------------------
DROP TABLE IF EXISTS `chatfriend_read_receipts`;
CREATE TABLE `chatfriend_read_receipts` (
  `id` varchar(50) NOT NULL,
  `message_id` varchar(50) NOT NULL,
  `user_id` varchar(50) NOT NULL,
...
-- ----------------------------
-- Table structure for chatfriend_contacts
-- ----------------------------
DROP TABLE IF EXISTS `chatfriend_contacts`;
CREATE TABLE `chatfriend_contacts` (
  `id` varchar(50) NOT NULL,
  `user_id` varchar(50) NOT NULL,
...
-- ----------------------------
-- Table structure for chatfriend_group_members
-- ----------------------------
DROP TABLE IF EXISTS `chatfriend_group_members`;
CREATE TABLE `chatfriend_group_members` (
  `id` varchar(50) NOT NULL,
...
-- ----------------------------
-- Table structure for chatfriend_notifications
-- ----------------------------
DROP TABLE IF EXISTS `chatfriend_notifications`;
CREATE TABLE `chatfriend_notifications` (
  `id` varchar(50) NOT NULL,
  `user_id` varchar(50) NOT NULL,
...
-- ----------------------------
-- Add standard performance indexes on existing tables where lacking
-- ----------------------------
ALTER TABLE `aigc_message` ADD INDEX `idx_user_id` (`user_id`);
ALTER TABLE `aigc_conversation` ADD INDEX `idx_user_id` (`user_id`);
